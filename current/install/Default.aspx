<%@ Page Language="C#" AutoEventWireup="true" Inherits="install_Default" Codebehind="Default.aspx.cs" %>
...
<body>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server"
            ...
            ErrorMessage="Email address is required" validationgroup="Required"></asp:RequiredFieldValidator>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"
            ControlToValidate="password" CssClass="bad" ErrorMessage="Password is required" validationgroup="Required"></asp:RequiredFieldValidator>
        <br />
        <br />
        <asp:Button ID="createUser" runat="server" onclick="createUser_Click"
            Text="Create User" validationgroup="Required"/>
